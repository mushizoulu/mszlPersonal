const pickPostLocales = window.siteData.locales;
...
let pickPostLocale = pickPostLocales[window.localStorage.getItem("site-locale")] ? window.localStorage.getItem("site-locale") : "zh-Hans";
