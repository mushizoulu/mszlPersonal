const picksLocales = window.siteData.locales;
const picksPerPage = window.siteData.itemLimit;
...
let picksLocale = picksLocales[window.localStorage.getItem("site-locale")] ? window.localStorage.getItem("site-locale") : "zh-Hans";
