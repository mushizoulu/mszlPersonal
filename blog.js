const blogLocales = window.siteData.locales;
const perPage = window.siteData.itemLimit;
const blogButtons = Array.from(document.querySelectorAll(".locale-button"));
const searchParams = new URLSearchParams(window.location.search);

let blogLocale = blogLocales[window.localStorage.getItem("site-locale")] ? window.localStorage.getItem("site-locale") : "zh-Hans";
